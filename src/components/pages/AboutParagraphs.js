// BACKSTORY
const backstoryOne = "In the fall of 2019, I took a leap. I decided to change careers from banker to developer. By this time, I had already been learning and doing front-end on the side for some time and I felt like it was the thing I wanted to do. I still do, thank god."
...
const whyFrontEndTwo = "I would lie if I said I never questioned my choice, the leap. After three hours down trying to solve a bug that turns out being a spelling mistake in the entry path in the webpack config file, yes, I questioned my choice. Or when, after deployment of a site, I realized I've styled the whole project with 175% zoom in the browser, yes, I questioned my choice. But in the end, when a problem is solved, especially a problem that seemed near impossible, it’s all worth it."

const whyFrontEndThree = "A big part of the charm with development, for me, is dealing with contrasting feelings. One day feeling like the dumbest person on the planet and the next a real genius. I love the twist and turns."
