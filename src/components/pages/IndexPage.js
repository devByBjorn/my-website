    ...
    <div className="container">
      <main className="main-index-content margin-top-8">
        ...
        <div className="short-bio">
          <p className="p">I’m continuously learning how to build and style stuff for the web. If you're interested; check out my <NavLink to="/portfolio" className="stand-out-word">portfolio</NavLink>, or go directly to my <a href="https://github.com/devByBjorn" target="blank"><span className="stand-out-word">GitHub</span></a> page.</p>
